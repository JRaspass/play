...
deploy: build
	...
	@ssh root@play-perl6.org "docker pull jraspass/play-perl6:latest && docker rm -f play-perl6; docker run --name play-perl6 --read-only --rm --tmpfs /tmp -dp 80:1080 -p 443:1443 -v /root/.acme.sh/play-perl6.org:/tls jraspass/play-perl6"
